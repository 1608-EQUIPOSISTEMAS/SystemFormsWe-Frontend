        ...
        <div class="login-container">
            ...
            <div class="brand-panel">
                ...
                <div class="brand-content">
                    ...
                    <p class="brand-tagline">Transformando el futuro</p>
                </div>
            ...
            <div class="form-panel">
                ...
                <div class="mascot-corner">
                    <img :src="mascotImg" alt="" class="mascot-corner-image" />
                </div>
...
import mascotImg from '@/assets/images/cortito.png'
...
.login-container .mascot-bg-image {
    width: 85%;
    max-width: 500px;
    height: auto;
    object-fit: contain;
...
.login-container .snowflake:nth-child(1) { left: 10%; animation-duration: 12s; animation-delay: 0s; }
.login-container .snowflake:nth-child(2) { left: 25%; animation-duration: 14s; animation-delay: 2s; font-size: 1.2rem; }
.login-container .snowflake:nth-child(3) { left: 40%; animation-duration: 10s; animation-delay: 4s; }
.login-container .snowflake:nth-child(4) { left: 55%; animation-duration: 16s; animation-delay: 1s; }
.login-container .snowflake:nth-child(5) { left: 70%; animation-duration: 11s; animation-delay: 3s; font-size: 1.1rem; }
.login-container .snowflake:nth-child(6) { left: 85%; animation-duration: 13s; animation-delay: 5s; }
...
.login-container .mascot-corner-image {
    width: 250px;
    height: auto;
    opacity: 0.12;
    filter: grayscale(20%);
...
@media (max-width: 1024px) {
    .login-container .brand-panel { width: 45%; padding: 30px; }
    .login-container .form-panel { width: 55%; padding: 30px; }
    .login-container .brand-logo .logo-w,
    .login-container .brand-logo .logo-e { font-size: 3.5rem; }
    .login-container .brand-logo .logo-separator { font-size: 3rem; }
    .login-container .brand-name { font-size: 0.9rem; letter-spacing: 2px; }
    .login-container .form-header h1 { font-size: 1.75rem; }
}

@media (max-width: 768px) {
    .login-container { flex-direction: column; overflow-y: auto; }
    .login-container .brand-panel { display: none; }
    .login-container .mascot-corner { display: none; }
    .login-container .form-panel {
        width: 100%;
        height: 100%;
        min-height: 100vh;
    ...
    .login-container .form-container { max-width: 100%; }
    ...
    .login-container .form-header { text-align: center; margin-bottom: 28px; }
    .login-container .form-header h1 { font-size: 1.5rem; }
    .login-container .login-form { gap: 20px; }
}

@media (max-width: 480px) {
    .login-container .form-panel { padding: 32px 20px; }
    .login-container .form-options { flex-direction: column; align-items: flex-start; gap: 12px; }
    .login-container .form-header h1 { font-size: 1.35rem; }
    .login-container .form-header p { font-size: 0.85rem; }
    .login-container .mobile-logo-circle { width: 70px; height: 70px; }
    .login-container .mobile-logo-circle .logo-w,
    .login-container .mobile-logo-circle .logo-e { font-size: 1.35rem; }
}
</style>